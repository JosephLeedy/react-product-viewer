...
export default async function Product(request: Request, response: ExpressResponse): Promise<void> {
    ...
    const requestUrl: string = 'https://commerce246.test/rest/V1/products/' + request.params.sku
